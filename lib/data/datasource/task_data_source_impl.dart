...
import 'package:taskz/data/datasource/sql_constants.dart';
import 'package:taskz/data/datasource/task_data_source.dart';
import 'package:taskz/domain/models/task.dart';
import 'package:path/path.dart' as path;
import 'package:sqflite/sqflite.dart' as sql;
import 'package:taskz/domain/models/task_type.dart';
import 'package:taskz/data/datasource/transformer.dart';

class TaskDataSourceAsDatabase extends TaskDataSource {
  Future<Database> _getDatabase() async {
    final dbPath = await sql.getDatabasesPath();
    final db = await sql.openDatabase(
      path.join(dbPath, 'taskz.db'),
      onCreate: (db, version) {
